...
#define MIN_SOBEL_X_THRESH    30  // 15  35
#define MAX_SOBEL_X_THRESH    60  // 40  100
#define MIN_SOBEL_Y_THRESH    20  // 15  30 
#define MAX_SOBEL_Y_THRESH    255  // 30 255
#define MIN_SOBEL_MAG_THRESH  30  // 18  30
#define MAX_SOBEL_MAG_THRESH  255  // 60  255
#define MIN_SOBEL_DIR_THRESH  0 // 0.99    0.7  
#define MAX_SOBEL_DIR_THRESH  0.4  // 1.0  1.3
#define MIN_BGR_R_THRESH      180 // 60 init 190(黄线)
#define MAX_BGR_R_THRESH      255 // 70
#define MIN_HLS_S_THRESH      80 // 20  85 
#define MAX_HLS_S_THRESH      255 // 60  255
...
#define MIN_LUV_THRESH        195 // 
#define MAX_LUV_THRESH        255 // 
#define MIN_LAB_THRESH        140 // 
#define MAX_LAB_THRESH        200 // 
...
public:
	...
	Mat luv_thresh(int thresh_min = -1, int thresh_max = 255);
	Mat lab_thresh(int thresh_min = -1, int thresh_max = 255);
...
private:
	...
	// 滤波用
	Mat _luv_l_channel,_lab_b_channel;
